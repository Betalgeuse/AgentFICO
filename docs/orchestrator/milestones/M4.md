# AgentFICO - Milestone M4: Testnet Deploy

## Current Progress (2026-01-29)
- [x] M4-001: Foundry 프로젝트 세팅
- [x] M4-002: AgentFICOScore.sol 구현
- [x] M4-003: 단위 테스트 (46개 통과)
- [x] M4-004: 배포 스크립트 작성
- [ ] M4-005: Base Sepolia 배포
- [ ] M4-006: 배포 문서화
...
| Field | Value |
|:---|:---|
| **Milestone ID** | M4-testnet-deploy |
...
- Base Sepolia 테스트넷 배포 및 검증
- Basescan 컨트랙트 검증
- 배포 문서화

## Non-Goals
- Mainnet 배포 (테스트넷 검증 + GTM 이후 별도 결정)
- DeFi 프로토콜 통합 (M8)
- 프론트엔드 대시보드 (M6)
